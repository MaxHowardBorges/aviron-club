...
<body>
    ...
    <div class="titre-page">
        <h1>St Cassien Rowing Center</h1>
    </div>
    <div class="neutre">
    ...
    <div class="bloc_impair">
        ...
        <div class="container">
            <div class="mySlides" style="display: block;">
                ...
                <img src="assets/img/base_vu_hauteur.jpg" style="width:100%">
            </div>

            <div class="mySlides">
                <div class="numbertext">2 / 3</div>
                <img src="assets/img/Base Aviron St Cassien.JPG" style="width:100%">
            </div>

            <div class="mySlides">
                <div class="numbertext">3 / 3</div>
                <img src="assets/img/base 750_3410.jpg" style="width:100%">
            </div>
            ...
            <div class="row">
                <div class="column">
                    <img class="demo cursor" src="assets/img/base_vu_hauteur.jpg" style="width:100%" onclick="currentSlide(1)">
                </div>
                <div class="column">
                    <img class="demo cursor" src="assets/img/Base Aviron St Cassien.JPG" style="width:100%" onclick="currentSlide(2)">
                </div>
                <div class="column">
                    <img class="demo cursor" src="assets/img/base 750_3410.jpg" style="width:100%" onclick="currentSlide(3)">
                </div>
            </div>
        </div>
    </div>
    <div class="bloc_pair">
        <div class="container">
            <div class="mySlides" style="display: block;">
                <div class="numbertext">1 / 3</div>
                <img src="assets/img/lac_st_cassien_aviron.jpg" style="width:100%">
            </div>
            ...
            <div class="row">
                <div class="column">
                    <img class="demo cursor" src="assets/img/lac_st_cassien_aviron.jpg" style="width:100%" onclick="currentSlide(1)">
                </div>
                <div class="column">
                    <img class="demo cursor" src="assets/img/Base Aviron St Cassien.JPG" style="width:100%" onclick="currentSlide(2)">
                </div>
    ...
    <div class="bloc_impair">
        ...
        <div class="image">
            <img class="img" src="assets/img/competition_top_2019.jpg" alt="Athletes in training for competition" />
        </div>
    </div>
    <div class="bloc_pair">
        <div class="image">
            <img class="img" src="assets/img/aviron_lac_st_cassien_automne.jpg" alt="View of the Saint Cassien lake in autumn" />
        </div>
        <div class="texte">
