...
<html lang="en">
    ...
    <div class="meteo-langue">
        ...
        <div class="langue"><a href="fr_bienvenue.php" title="Page française"><img id="langue" src="assets/img/flag_french.jpg" alt="langue anglais" width="90" height="60"></a></div>
    </div>

    <div id="background">      

        <div id="bb"><button id="b1" onclick="window.location.href = 'en_rowingcenter.php';">Saint Cassien International Rowing Center</button>
        <button id="b2" onclick="window.location.href = 'en_rowingclub.php';">Saint Cassien <br>Rowing Club</button></div>
    ...
    <div id="acces">
        ...
        <div id="button_savoir_plus">
            <button id="b3" onclick="window.location.href = 'en_information.php';">Learn more</button>
        </div>
    </div>
    </body>
    <footer id="foot">
