...
<body>
    <div class="meteo-langue">
        ...
        <div class="langue"><a href="fr_informations.php" title="Page française"><img id="langue" src="assets/img/flag_french.jpg" alt="langue anglais" width="90" height="60"></a></div>
    </div>
