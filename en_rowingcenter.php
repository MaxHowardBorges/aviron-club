...
<body>
    <div class="meteo-langue">
        ...
        <div class="langue"><a href="fr_baseaviron.php" title="Page française"><img id="langue" src="assets/img/flag_french.jpg" alt="langue anglais" width="90" height="60"></a></div>
    </div>
    ...
    <div class="bloc_impair">
        <div class="texte">
            ...
            <div class="boutton">
                <button id="contact" onclick="window.location.href = 'en_contact.php';">Contact</button>
            </div>
        </div>
        <div class="container">
            <div class="mySlides" style="display: block;">
